...
/*
+ Экспертиза: проект, тз, бизнес план, презентация
+ результаты сопровождения проекта:
+ управление рисками и гарантиями: риски проекта, план реагирования, степень критичности (оценивается в деньгах)
+ учет рисков
+ договоры + транзакции оплаты по договорам
+ урегулирование спорво
интеграция: данные для учетных систем (1с и тд и тп)
*/
